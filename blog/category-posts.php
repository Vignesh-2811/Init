    ...
    <section class="featured">
        <div class="container featured__container">
            <div class="post__thumbnail">
                <img src="./assets/images/blog1.jpg" alt="asdf">
            </div>
            <div class="post__info">
                <a href="category-posts.html" class="category__button">Wild Life</a>
                <h2 class="post__title"><a href="post.html">ajfhasueif asiudhfa usdf awoefha sohn</a></h2>
                <p class="post__body">asuidghiugfwaiuefgasodhfu au efauwgef aweuge7rf asduifgawef asidfggwegfa jsduifgaf</p>
