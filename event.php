<?php include('includes/header.php'); ?>
  ...
  <!-- themefy-icon -->
  <link rel="stylesheet" href="assets\img\themify-icons\themify-icons.css">
  <!-- animation css -->
  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-12 mb-4">
        <img src="assets\img\about.jpg" alt="event thumb" class="img-fluid w-100">
      </div>
    </div>
    <!-- event info -->
...
<!-- filter -->
<script src="assets\filterizr\jquery.filterizr.min.js"></script>
